...
import VpsPageClient from "./VpsPageClient";

export const metadata: Metadata = {
  title: "Scalable Virtual Private Server Plans",

  description:
    "Get powerful VPS hosting with NVMe SSD, full root accessfree SSL, DDoS protection & 99.9% uptime",
