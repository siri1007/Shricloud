...
//           <span className="style-border ">partnership</span>
        ...
        >
          <div className={styles.marqueeTrack}>
            <div className={styles.marqueeContent}>
              ...
              <Image src={litespeed} alt="LiteSpeed Duplicate" />
              <Image src={softaculous} alt="Softaculous Duplicate" />
              <Image src={intel} alt="Intel Duplicate" />
              <Image src={aws} alt="AWS Duplicate" />
              <Image src={cloudlinux} alt="CloudLinux Duplicate" />
            </div>
          </div>
        </div>
      </div>
