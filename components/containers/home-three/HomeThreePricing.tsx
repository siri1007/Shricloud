  ...
  const monthlyPlans: Plan[] = [
    {
      ...
      secondButtonLink: "/pricing",
      features: [
        { title: "1 Website", value: true, tooltip: "Host 1 website." },
        { title: "Managed WordPress", value: true, tooltip: "Optimized WP hosting." },
        { title: "10 GB SSD Storage", value: true, tooltip: "Fast SSD storage." },
        { title: "No Free Domain", value: false, tooltip: "No free domain." },
        { title: "No Subdomain", value: false, tooltip: "No subdomains." },
        { title: "10 Business Email", value: true, tooltip: "10 emails." },
        { title: "Free SSL Certificates", value: true, tooltip: "SSL included." },
        { title: "No Backups", value: false, tooltip: "No backups." },
        { title: "Free Cloudflare CDN", value: true, tooltip: "CDN included." },
        { title: "Free Migration", value: true, tooltip: "Free migration." },
        { title: "Control Panel", value: true, tooltip: "Easy control panel." },
        { title: "Malware Scanning", value: true, tooltip: "Security scan." },
        { title: "Priority Support", value: true, tooltip: "Fast support." },
        ...
        { title: "LiteSpeed Servers", value: true, tooltip: "Fast servers." },
        { title: "Redis Cache", value: true, tooltip: "Cache system." },
        { title: "LSCache", value: true, tooltip: "Speed boost." },
        { title: "MemCached", value: true, tooltip: "Memory cache." },
        { title: "WordPress Optimized", value: true, tooltip: "WP tuned." },
        ...
        { title: "1 Click Installation", value: true, tooltip: "Install WP." },
        { title: "Staging", value: false, tooltip: "Not included." },
        { title: "Cloning", value: false, tooltip: "Not included." },
        { title: "On Demand Backups", value: false, tooltip: "Not included." },
        { title: "WordPress Multisite", value: false, tooltip: "Not included." },
        { title: "In Memory Cache", value: true, tooltip: "Fast cache." },
        { title: "WordPress Security", value: true, tooltip: "Secure WP." },
      ],
    },

    {
      ...
      secondButtonLink: "/pricing",
      features: [
        { title: "50 Websites", value: true, tooltip: "Host 50 sites." },
        { title: "Managed WordPress", value: true, tooltip: "Optimized WP." },
        { title: "100 GB SSD Storage", value: true, tooltip: "Fast storage." },
        { title: "Free Domain", value: true, tooltip: "1 year free domain." },
        { title: "100 Subdomains", value: true, tooltip: "Subdomains." },
        ...
        { title: "Free Cloudflare CDN", value: false, tooltip: "CDN not included." },
        { title: "Free Migration", value: true, tooltip: "Migration free." },
        { title: "Control Panel", value: true, tooltip: "Panel." },
        { title: "Malware Scanning", value: true, tooltip: "Scan." },
        { title: "Priority Support", value: true, tooltip: "Support." },
        ...
        { title: "LiteSpeed Servers", value: true, tooltip: "Fast server." },
        { title: "Redis Cache", value: true, tooltip: "Cache." },
        { title: "LSCache", value: true, tooltip: "LS cache." },
        { title: "MemCached", value: false, tooltip: "Not included." },
        { title: "WordPress Optimized", value: true, tooltip: "Optimized." },
        { title: "Turbo PHP", value: true, tooltip: "Fast PHP." },
        ...
        { title: "WordPress Multisite", value: true, tooltip: "Multi WP." },
...

    {
      ...
      secondButtonLink: "/pricing",
      features: [
        { title: "100 Websites", value: true, tooltip: "100 sites." },
        { title: "Managed WordPress", value: true, tooltip: "WP managed." },
        { title: "300 GB SSD Storage", value: true, tooltip: "Storage." },
        { title: "Free Domain", value: true, tooltip: "Domain." },
        { title: "Unlimited Subdomains", value: true, tooltip: "Subdomains." },
        { title: "Unlimited Email", value: true, tooltip: "Emails." },
        { title: "Unlimited SSL", value: true, tooltip: "SSL." },
        { title: "Daily Backups", value: true, tooltip: "Backup." },
        { title: "Free Cloudflare CDN", value: true, tooltip: "CDN." },
        { title: "Free Migration", value: true, tooltip: "Migration." },
        { title: "Control Panel", value: true, tooltip: "Panel." },
        { title: "Malware Scanning", value: true, tooltip: "Scan." },
        { title: "Priority Support", value: true, tooltip: "Support." },
        ...
        { title: "LiteSpeed Servers", value: true, tooltip: "Server." },
        { title: "Redis Cache", value: true, tooltip: "Cache." },
        { title: "LSCache", value: true, tooltip: "LSCache." },
        { title: "MemCached", value: true, tooltip: "Cache." },
        { title: "WordPress Optimized", value: true, tooltip: "WP." },
        { title: "Turbo PHP", value: true, tooltip: "PHP." },
...

    {
      ...
      secondButtonLink: "/pricing",
      features: [
        { title: "Unlimited Websites", value: true, tooltip: "Unlimited sites." },
        { title: "8 GB RAM", value: true, tooltip: "RAM." },
        { title: "4 vCPU", value: true, tooltip: "CPU." },
        { title: "Free SSL", value: true, tooltip: "SSL." },
        { title: "Unlimited Storage", value: true, tooltip: "Storage." },
        { title: "Free Domain", value: true, tooltip: "Domain." },
        { title: "Unlimited Subdomains", value: true, tooltip: "Sub." },
        { title: "Unlimited DB", value: true, tooltip: "DB." },
        { title: "Control Panel", value: true, tooltip: "Panel." },
        { title: "Daily Backups", value: true, tooltip: "Backup." },
        { title: "Migration", value: true, tooltip: "Migration." },
          { title: "Malware Scanning", value: true, tooltip: "Scan." },
        { title: "Priority Support", value: true, tooltip: "Support." },
        ...
        { title: "Staging", value: true, tooltip: "Staging." },
        { title: "Cloning", value: true, tooltip: "Clone." },
        { title: "Backups", value: true, tooltip: "Backup." },
          { title: "WordPress Multisite", value: true, tooltip: "Multi." },
        { title: "In Memory Cache", value: true, tooltip: "Cache." },
        { title: "WordPress Security", value: true, tooltip: "Secure." },
      ],
