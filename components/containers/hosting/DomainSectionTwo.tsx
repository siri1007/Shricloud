...
// import shape from "@/public/img/domain/wing-shape.png";
...
// const DomainSectionTwo = () => {
//   return (
//     <section className="domain-hosting-section fix section-padding">
...
//             data-aos-delay="200"
//           >
//             <div className="domain-card-items">
...
//                 evolve user revolutionary hosting.
//               </p>
//               <Link href="contact" className="theme-btn">
//                 Register <i className="fa-regular fa-chevrons-right"></i>
//               </Link>
//             </div>
//           </div>
//           <div
...
// export default DomainSectionTwo;
    ...
    <section className="choose-us-section fix section-padding">
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2>
           Why Register Domains at Shricloud
          </h2>
        </div>
          ...
          >
            <div className="choose-us-card-items">
              ...
              <div className="content">
                <h3>  Great Prices</h3>
                <p>
Register, transfer and renew domain names for a cheaper
<br></br> rates.
                </p>
              </div>
            </div>
...
Manage your domains with an easy-to-use control panel and 
<br></br> dashboard.
                </p>
              </div>
            </div>
